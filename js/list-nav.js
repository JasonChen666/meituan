...
/****************************全部分类下拉菜单*****************************/
var allkinds = document.getElementById("nav_allkinds");
var allkindsimg = document.getElementById("allkinds_img");

allkinds.onmouseover = function() {
	nav_all.style.display = "block";
	allkindsimg.src = "images/allkinds-up.png";
}

allkinds.onmouseout = function() {
	nav_all.style.display = "none";
	allkindsimg.src = "images/allkinds-down.png";
}

nav_all.onmouseover = function() {
	nav_all.style.display = "block";
	allkindsimg.src = "images/allkinds-up.png";
}

nav_all.onmouseout = function() {
	nav_all.style.display = "none";
	allkindsimg.src = "images/allkinds-down.png";
}